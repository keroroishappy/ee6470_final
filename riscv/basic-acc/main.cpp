...
public:
	...
	addr_t short_path_start_addr = 0x73000000;
 	addr_t short_path_size = 0x10000000;
 	addr_t short_path_end_addr = short_path_start_addr + short_path_size - 1;
	...
	void parse(int argc, char **argv) override {
		...
		assert((mem_end_addr < clint_start_addr || mem_start_addr > short_path_end_addr) &&
...
int sc_main(int argc, char **argv) {
	...
	bus.ports[12] = new PortMapping(opt.short_path_start_addr, opt.short_path_end_addr);
	...
	bus.isocks[12].bind(short_path.tsock);
